...
## Project Structure
    ...
    ├── testapiautodatamod_122841  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_122841`
...
2. Clone this repo and `cd testapiautodatamod_122841`
